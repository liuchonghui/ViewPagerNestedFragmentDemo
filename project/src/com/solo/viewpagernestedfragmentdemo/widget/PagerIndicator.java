 ...
 */
public class PagerIndicator extends HorizontalScrollView implements PageIndicator
		 {
	...
	private final OnClickListener mTabClickListener = new OnClickListener() {
		public void onClick(View view) {
			...
			mViewPager.setCurrentItem(newSelected, smoothScroll);
	...
	private class TabView extends TextView {
		...
		public TabView(Context context) {
			...
			this.setPadding(dpToPx(context, 0), dpToPx(context, 12),
					dpToPx(context, 0), dpToPx(context, 12));
		}
